(function($) {
	...
	var showSuccessOrErrorText = function ($element, text, isSuccess) {
		return $element.html(text).toggleClass('text-danger', !isSuccess).toggleClass('text-success', isSuccess);
	};
	...
	UI.prototype.showErrorText = function($element, text) {
		return showSuccessOrErrorText($element, text, false);
	};

	UI.prototype.showSuccessText = function($element, text) {
		return showSuccessOrErrorText($element, text, true);
	};
